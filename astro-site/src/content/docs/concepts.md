...
<img src="/images/git-configuration-model.png" alt="Configuration Model" />
...
<img src="/images/git-object-model.png" alt="Git Objects" />
...
-------------------------------------------------------------------------------
### Reference model
<img src="/images/git-references.png" alt="Reference model" />
...
<img src="/images/git-branch-navigation.png" alt="Branch navigation" />
...
<img src="/images/git-branch-overview.png" alt="branch" />
...
- the initial state of the repository looks like this...
    > <img src="/images/git-branch-before.png" alt="Initial repo" />
  
- after creating and switching to a new branch the repo changes to...
    > <img src="/images/git-branch-new.png" alt="New branch" />

- after making a new commit to the new branch the repo changes to...
    > <img src="/images/git-branch-change-bugfix.png" alt="Change bugfix" />

- after switching and committing to the main branch the repo changes to...
    > <img src="/images/git-branch-change-main.png" alt="Change main" />

- as final the branches are merged and the repo changes to...
    > <img src="/images/git-branch-merge.png" alt="Merge branches" />
...
<img src="/images/git-merge-concept.png" alt="Merge Fast Forward" />
...
<img src="/images/git-merge-fast-forward.png" alt="Merge Fast Forward" />
...
<img src="/images/git-merge-rebase.png" alt="Merge Fast Forward" />
...
<img src="/images/git-merge-3-way-concept.png" alt="Merge Fast Forward" />
...
<img src="/images/git-selectors-tilde.png" alt="Git Selectors" />
...
<img src="/images/git-selectors-caret.png" alt="Git Selectors" />
...
<img src="/images/git-selectors-double-dot.png" alt="Git Selectors" />
...
```
<img src="/images/git-selectors-triple-dot.png" alt="Git Selectors" />
...
<img src="/images/git-selectors.png" alt="Git Selectors" />
...
> <img src="/images/git-submodules.png" alt="submodules" />
...
> <img src="/images/git-subtrees.png" alt="Git Subtrees" />
