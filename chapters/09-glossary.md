...
| Blame | Show which commit and author last modified each line of a file | [7](playbook/debugging.md) |
...
| Revert | Create a new commit that undoes a previous commit's changes without rewriting history | [7](playbook/undoing-changes.md) |
