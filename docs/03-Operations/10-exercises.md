## Operations — Hands-On Exercises

Practice real git workflows using the commands from this section. Each exercise
uses a temporary repository that you create from scratch. Work through them in
order — later exercises build on skills from earlier ones.
